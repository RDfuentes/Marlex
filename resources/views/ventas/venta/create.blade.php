...
@section ('contenido')
	...
	<div class="row">
		<div class="col-xs-12">
			<a class="btn btn-danger" href="{{ url('/compras/ingreso') }}" >Cancelar Venta</a>
			<h3 class="text-center"><strong>Nueva Venta</strong></h3>
			@if (count($errors)>0)
...
// AGREGADO PARA MOSTRAR EL VALOR DE INGRESO DEL PRODUCTO ||||||||||||||||||||||||||||||||||||||||||
