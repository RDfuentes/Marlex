...
<div class="row">
	<div class="col-xs-12">
		<a href="proveedor/create"><button class="btn btn-success">Nuevo Proveedor</button></a>
		<h3 class="text-center"><strong>Listado de Proveedores</strong></h3>
...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="table-responsive">
			...
			<caption class="text-center">LISTADO DE PROVEEDORES</caption>
