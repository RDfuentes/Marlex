...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
         ...
         <!-- Logo -->
        <a href="{{ url('/almacen/categoria') }}" class="logo"> 
          <!-- mini logo for sidebar mini 50x50 pixels -->
          <span class="logo-mini"><b>M</b>P</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>MARLEX</b></span>
        </a>
 ...
 <!-- sidebar menu: : style can be found in sidebar.less -->
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ url('/almacen/categoria') }}"><i class="fa fa-circle-o"></i>Categorias Productos</a></li>
                <li><a href="{{ url('/almacen/articulo') }}"><i class="fa fa-circle-o"></i>Productos</a></li>
              </ul>
            </li> 
      ...
      <footer class="main-footer">
       <div>MARLEX - LA CASA DEL PANTALON</div>
      </footer>
